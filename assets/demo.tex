...
\begin{tabularx}{\linewidth}{@{}lL@{}}
	...
	& \texttt{true} will turn on the ability to see images inserted with \texttt{\textbackslash includegraphics}. \texttt{false} produces an empty frame of the image, allowing faster compile times. \\
\end{tabularx}
